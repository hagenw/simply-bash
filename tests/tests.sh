...
assert "envs virtualenv" "# virtualenv environments:"
assert_true "envs virtualenv && create pip-env"
assert "envs" "pip-env"
assert_true "envs virtualenv && activate pip-env && deactivate"
assert_true "envs virtualenv && delete pip-env"
assert_false "envs virtualenv && activate pip-env"
assert "envs" ""
